...
namespace ExpressionSerialization
{
    public partial class ExpressionSerializer
    {
        ...
        /// 构造函数
        /// </summary>
        /// <param name="typeDllPath">指定需要序列化\反序列化的类型所在的DLL路径</param>
        public ExpressionSerializer(String typeDllPath)
        {
            this.resolver = new TypeResolver(null, null, typeDllPath);
            Converters = new List<CustomExpressionXmlConverter>();
        }
