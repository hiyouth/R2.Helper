   ...
   public class EMail
    {
        public static void SendEMail()
        {
            ...
            //如果需要认证，则用下面的方式
            smtp.Credentials = new NetworkCredential("499055803@qq.com", "ll38966621314520");

            MailMessage mm = new MailMessage(); //实例化一个邮件类

            mm.Priority = MailPriority.High; //邮件的优先级，分为 Low, Normal, High，通常用 Normal即可

            mm.From = new MailAddress("499055803@qq.com", "雷磊", Encoding.GetEncoding(936));
            //收件方看到的邮件来源；
            //第一个参数是发信人邮件地址
            //第二参数是发信人显示的名称
      ...
      //      mm.ReplyTo = new MailAddress("test_box@gmail.com", "我的接收邮箱", Encoding.GetEncoding(936));
           ...
           // mm.Sender = new MailAddress("xxx@xxx.com", "邮件发送者", Encoding.GetEncoding(936));
            ...
            mm.To.Add("aswindguy@outlook.com,499055803@qq.com");
            ...
            mm.Body = @"<font color='green'>邮件测试，呵呵</font>";
            //邮件正文
